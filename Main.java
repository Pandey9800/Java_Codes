...
//                System.out.print(" ");
//            }
//            for(int columnF=1;columnF<=(2*row-1);columnF++){
//                System.out.print("*");
//            }
//            System.out.println();
//        }
...
//Code to print Hollow Pyramid By taking input from user
...
//        int rows = ip.nextInt();
//        for(int h=1;h<=rows;h++) { ------------------>/* Loop for rows */
//            for(int i=h;i<rows;i++){ ------------------>/* Loop for spaces outside the Astric's   */
//                System.out.print(" ");
//            }
//            for (int j=1; j<=(2*h-1);j++) { ------------------>/* Loop to Print Astric's || Spaces inside the Pyramid */
//                if (h==rows || j==1 || j==(2*h-1)) {
//                    System.out.print("*");
//                }
//                else {
//                    System.out.print(" ");
...
//Code to Print Hollow Pyramid Without taking user input
...
//            for(int j=i;j<5;j++){        // Loop for spaces outside the Astric's
//                System.out.print(" ");
//            }
//            for (int k=1; k<=(2*i-1);k++) {    // Loop to Print Astric's AND/OR Spaces inside the Pyramid
//                if (i==5 || k==1 || k==(2*i-1)) {
//                    System.out.print("*");
//                }
//                else {
...
// java program to check whether a String is palindrom or not
//import java.util.*;
//class Source
//{
//    public static void main(String args[])
...
//        int x= str.length()-1;
//        for(int j= x; x>=j && j>=0;j--){
//        char rev = str.charAt(j);
//        System.out.print(rev);}
//        }
//}

//Code to reverse String Using While Loop
//import java.util.Scanner;
//class Source{
//    public static void main(String args[]){
//        Scanner ip=new Scanner(System.in);
...
//Code to check whether a string is palindrome or not using 2 pointer approach
//import java.util.*;
//class Source {
//    public static void main(String[] args) {
//        Scanner ip = new Scanner(System.in);
...
//Code to find missing number is array
//import java.util.*;
//class Source {
//    public static void main(String[] args) {
//        Scanner ip = new Scanner(System.in);
...
//    String city,street,state,name,phone,email;
//    float calculateDiscount(){
//        return 0.1f*num_of_transactions;
//    }
...
// Solution of practice code my way
...
// Solution of practice code UpGrads Way.
